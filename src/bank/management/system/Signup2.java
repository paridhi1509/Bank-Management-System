...
public  class Signup2 extends JFrame implements ActionListener {
    ...
    Signup2(String formno){
        ...
        comboBox.setBackground(new Color(186, 161, 227));
        ...
        comboBox2.setBackground(new Color(186, 161, 227));
        ...
        comboBox3.setBackground(new Color(186, 161, 227));
        ...
        comboBox4.setBackground(new Color(186, 161, 227));
        ...
        comboBox5.setBackground(new Color(186, 161, 227));
        ...
        r1.setBackground(new Color(186, 161, 227));
        r1.setBounds(350,490,100,30);
        add(r1);
        r2 = new JRadioButton("No");
        r2.setFont(new Font("Raleway", Font.BOLD,14));
        r2.setBackground(new Color(186, 161, 227));
        ...
        e1.setBackground(new Color(186, 161, 227));
        e1.setBounds(350,540,100,30);
        add(e1);
        e2 = new JRadioButton("No");
        e2.setFont(new Font("Raleway", Font.BOLD,14));
        e2.setBackground(new Color(186, 161, 227));
        ...
        setSize(850,750);
        setLocation(450,80);
        getContentPane().setBackground(new Color(186, 161, 227));
        setVisible(true);
    }
